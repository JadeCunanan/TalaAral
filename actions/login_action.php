...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    try {
        ...
        if ($user && password_verify($password, $user['password_hash'])) {
            ...
            // Covers both wrong password AND unverified accounts
            $_SESSION['error_login'] = "Invalid credentials or account not yet verified. Please check your email.";
            header("Location: ../login.php");
            exit();
        }
        ...
        $_SESSION['error_login'] = "A system error occurred. Please contact the administrator.";
        header("Location: ../login.php");
        exit();
    }
}
    ...
    try {
        ...
        if ($user) {
            ...
            if (sendTalaAralEmail($email, $subject, $body)) {
                ...
                $_SESSION['error_recovery'] = "Mail delivery failed. Check server logs.";
            }
        } else {
